...
func (m *MockGameInterface) GetSectorParameter(sector int, name string) (string, error) { return "", nil }
...
func (m *MockGameInterface) GetAllCourses(from int) (map[int][]int, error) { return make(map[int][]int), nil }
func (m *MockGameInterface) GetNearestWarps(sector int, count int) ([]int, error) { return []int{}, nil }
...
func (m *MockGameInterface) GetSystemConstants() types.SystemConstantsInterface { return &MockSystemConstants{} }
